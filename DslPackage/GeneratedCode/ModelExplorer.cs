...
namespace CodeGeneration.DSL
{
	...
	/// </summary>
	internal partial class DSLExplorer : DSLExplorerBase
	{
		/// <summary>
		/// Constructs a new DSLExplorer.
		/// </summary>
		public DSLExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the DSLExplorerToolWindow.
	/// </summary>
	internal abstract class DSLExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new DSLExplorerBase.
		/// </summary>
		protected DSLExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.DSLExplorerMenu;
			}
		}
		...
		{
			get { return global::CodeGeneration.DSL.World.DomainClassId; }
		}
