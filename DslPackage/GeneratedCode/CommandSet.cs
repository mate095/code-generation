...
namespace CodeGeneration.DSL
{
	...
	/// </summary>
	internal partial class DSLCommandSet : DSLCommandSetBase
	{
		/// <summary>
		/// Constructs a new DSLCommandSet.
		/// </summary>
		public DSLCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class DSLCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new DSLCommandSetBase.
		/// </summary>
		protected DSLCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewDSLExplorerCommand,
				typeof(DSLEditorFactory).GUID);
		...
		{
			DSLExplorerToolWindow explorer = this.DSLExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected DSLDocData CurrentDSLDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as DSLDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected DSLDocView CurrentDSLDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as DSLDocView;
			}
		}
		...
		/// </summary>
		protected DSLExplorerToolWindow DSLExplorerToolWindow
		{
			get
			{
				DSLExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(DSLExplorerToolWindow), true) as DSLExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				DSLExplorerToolWindow explorerWindow = this.DSLExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class DSLClipboardCommandSet : DSLClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new DSLClipboardCommandSet.
		/// </summary>
		public DSLClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class DSLClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new DSLClipboardCommandSetBase.
		/// </summary>
		protected DSLClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
