...
namespace CodeGeneration.DSL
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.DSLEditorFactoryId)]
	internal partial class DSLEditorFactory : DSLEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new DSLEditorFactory.
		/// </summary>
		public DSLEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class DSLEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected DSLEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new DSLDocData(this.ServiceProvider, typeof(DSLEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new DSLDocView(docData, this.ServiceProvider);
		}
	}
}
