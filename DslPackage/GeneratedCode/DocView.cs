...
namespace CodeGeneration.DSL
{
	...
	/// </summary>
	internal partial class DSLDocView : DSLDocViewBase
	{
		/// <summary>
		/// Constructs a new DSLDocView.
		/// </summary>
		public DSLDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class DSLDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new DSLDocView.
		/// </summary>
		protected DSLDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			DSLDocDataBase docData = this.DocData as DSLDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for DSLDocViewBase should be an DSLDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::CodeGeneration.DSL.DSLDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::CodeGeneration.DSL.DSLDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::CodeGeneration.DSL.DSLToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::CodeGeneration.DSL.DSLToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.DSLDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::CodeGeneration.DSL.DSLHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::CodeGeneration.DSL.DSLHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::CodeGeneration.DSL.DSLHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
