...
namespace CodeGeneration.DSL
{
	...
	/// </remarks>
	internal partial class DSLHelpKeywordHelper : DSLHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new DSLHelpKeywordHelper.
		/// </summary>
		protected DSLHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the DSLHelpKeywordHelper.
		/// </summary>
		public static DSLHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	internal abstract class DSLHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new DSLHelpKeywordHelperBase.
		/// </summary>
		protected DSLHelpKeywordHelperBase()
			: base() { }
