...
namespace CodeGeneration.DSL
{
	...
	/// </remarks>
	internal partial class DSLToolboxHelper : DSLToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new DSLToolboxHelper.
		/// </summary>
		public DSLToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	internal abstract class DSLToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify DSL toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "DSL.1.0";
		...
		/// <summary>
		/// Constructs a new DSLToolboxHelperBase.
		/// </summary>
		protected DSLToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::CodeGeneration.DSL.DSLDomainModel.SingletonResourceManager.GetString("DSLToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::CodeGeneration.DSL.DSLDomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "CodeGeneration.DSL.ExampleElementToolboxItem":
					// Add ExampleElement shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"CodeGeneration.DSL.ExampleElementToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"CodeGeneration.DSL.DSLToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("DSLToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						...
						CreateElementToolPrototype(store, global::CodeGeneration.DSL.Animal.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::CodeGeneration.DSL.DSLDomainModel));
